...
## Create a schedule[​](#create-a-schedule "Direct link to create-a-schedule")
...
### Manual refresh[​](#manual-refresh "Direct link to manual-refresh")
...
### Trigger on update[​](#trigger-on-update "Direct link to trigger-on-update")
...
### Scheduled refresh[​](#scheduled-refresh "Direct link to scheduled-refresh")
...
### SQL task in a job[​](#sql-task-in-a-job "Direct link to sql-task-in-a-job")
...
## Add a schedule to an existing pipeline[​](#add-a-schedule-to-an-existing-pipeline "Direct link to Add a schedule to an existing pipeline")
...
## Modify an existing schedule or trigger[​](#modify-an-existing-schedule-or-trigger "Direct link to modify-an-existing-schedule-or-trigger")
...
### Drop a schedule or trigger[​](#drop-a-schedule-or-trigger "Direct link to Drop a schedule or trigger")
...
## Track the status of a refresh[​](#track-the-status-of-a-refresh "Direct link to track-the-status-of-a-refresh")
...
## Stop an active refresh[​](#stop-an-active-refresh "Direct link to stop-an-active-refresh")
...
## View the history of runs for a scheduled refresh[​](#view-the-history-of-runs-for-a-scheduled-refresh "Direct link to view-the-history-of-runs-for-a-scheduled-refresh")
...
## Timeouts for refreshes[​](#timeouts-for-refreshes "Direct link to Timeouts for refreshes")
...
### How scheduled refreshes handle timeouts[​](#how-scheduled-refreshes-handle-timeouts "Direct link to How scheduled refreshes handle timeouts")
...
* Changing the warehouse timeout alone does not affe