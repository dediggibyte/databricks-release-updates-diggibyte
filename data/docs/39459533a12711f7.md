...
### Step 3. Grant the recipient access to a share[​](#step-3-grant-the-recipient-access-to-a-share "Direct link to Step 3. Grant the recipient access to a share")
...
## Share with Iceberg recipient[​](#share-with-iceberg-recipient "Direct link to share-with-iceberg-recipient")

If your OIDC recipient is reading shared data assets using an Iceberg RES