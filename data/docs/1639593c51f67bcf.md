...
## Use OAuth instead of personal access tokens[​](#use-oauth-instead-of-personal-access-tokens "Direct link to Use OAuth instead of personal access tokens")
...
## Monitor and revoke personal access tokens in the account[​](#monitor-and-revoke-personal-access-tokens-in-the-account "Direct link to monitor-and-revoke-personal-access-tokens-in-the-account")
...
## Enable or disable personal access token authentication for the workspace[​](#enable-or-disable-personal-access-token-authentication-for-the-workspace "Direct link to enable-or-disable-personal-access-token-authentication-for-the-workspace")
...
## Control who can create and use personal access tokens[​](#control-who-can-create-and-use-personal-access-tokens "Direct link to control-who-can-create-and-use-personal-access-tokens")
...
## Set the maximum lifetime of new personal access tokens[​](#set-the-maximum-lifetime-of-new-personal-access-tokens "Direct link to set-the-maximum-lifetime-of-new-personal-access-tokens")
...
### Personal access token expiration notifications[​](#personal-access-token-expiration-notifications "Direct link to Personal access token expiration notifications")
...
#### Service principal token expiration notifications[​](#service-principal-token-expiration-notifications "Direct link to Service principal token expiration notifications")
...
## Monitor and revoke tokens in your workspace[​](#monitor-and-revoke-tokens-in-your-workspace "Direct link to monitor-and-revoke-tokens-in-your-workspace")
...
### Get tokens for the workspace[​](#get-tokens-for-the-workspace "Direct link to get-tokens-for-the-workspace")
...
### Delete (revoke) a token[​](#delete-revoke-a-token "Direct link to Delete (revoke) a token")
...
## Review token auto-scoping status[​](#review-token-auto-scoping-status "Direct link to Review token auto-scoping status")
