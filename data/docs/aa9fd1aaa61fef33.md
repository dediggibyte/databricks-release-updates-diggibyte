...
### SQL editor, notebooks, and other authoring surfaces[​](#sql-editor-notebooks-and-other-authoring-surfaces "Direct link to SQL editor, notebooks, and other authoring surfaces")
...
### Genie Agents[​](#genie-agents "Direct link to Genie Agents")
...
### Destination resolution logic[​](#destination-resolution-logic "Direct link to Destination resolution logic")
...
## Enable access requests across the metastore[​](#enable-access-requests-across-the-metastore "Direct link to enable-access-requests-across-the-metastore")
...
3. In the **Data Administration** tile, click the edit icon next to **Access Requests**.
