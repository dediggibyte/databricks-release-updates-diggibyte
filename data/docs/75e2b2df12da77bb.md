...
## Tour of the Genie Code pane[​](#tour-of-the-genie-code-pane "Direct link to tour-of-the-genie-code-pane")
...
### Work with multiple threads as tabs[​](#work-with-multiple-threads-as-tabs "Direct link to work-with-multiple-threads-as-tabs")
...
### Genie Code pane controls[​](#genie-code-pane-controls "Direct link to genie-code-pane-controls")
...
### Genie Code settings[​](#genie-code-settings "Direct link to genie-code-settings")
...
## Agent mode[​](#agent-mode "Direct link to agent-mode")
...
## Full page Genie Code (Beta)[​](#full-page-genie-code-beta "Direct link to full-page-genie-code-beta")
...
## Approve tool actions[​](#approve-tool-actions "Direct link to approve-tool-actions")
...
### Approve a single request[​](#approve-a-single-request "Direct link to Approve a single request")
...
### Set a default approval mode[​](#set-a-default-approval-mode "Direct link to Set a default approval mode")
...
## Share a chat thread[​](#share-a-chat-thread "Direct link to share-a-chat-thread")
...
## Get help with code[​](#get-help-with-code "Direct link to get-help-with-code")
...
### Code optimized for the Databricks environment[​](#code-optimized-for-the-databricks-environment "Direct link to code-optimized-for-the-databricks-environment")
...
## Get answers sourced from documentation[​](#get-answers-sourced-from-documentation "Direct link to get-answers-sourced-from-documentation")
...
## Give feedback on Genie Code answers[​](#give-feedback-on-genie-code-answers "Direct link to give-feedback-on-genie-code-answers")
